...
"""P5-v5 音频环节（钢琴收束）：
  ...
  5. 视频流 copy 自 video_silent_v5.mp4 -> final_v5.mp4
"""
...
VIDEO_SILENT = OUT / "video_silent_v5.mp4"
PIANO = TMP / "piano_ending.wav"
NARRATION = TMP / "narration_v5.mp3"
AMBIENT = TMP / "ambient_v5.wav"
FINAL = OUT / "final_v5.mp4"
META = TMP / "p5v5_audio_meta.json"
...
def main() -> int:
    ...
    print(f"[audio] video_silent_v5 时长 {duration:.3f}s", flush=True)
    ...
    print(f"[audio] final_v5 -> {FINAL}", flush=True)
