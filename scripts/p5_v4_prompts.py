...
FRAME_PROMPTS: dict[str, dict[str, str]] = {
    ...
    "shot2": {
        "first": _frame(
            ...
            f"暖白日光灯照明，玻璃柜反射店内灯光，室内货架背景，"
            f"店内招牌均为纯色发光灯牌无文字，中景固定机位，"
            f"主体居中偏左，电影感构图"
        ),
        "last": _frame(
            f"{STYLE_CN}。便利店室内关东煮柜台前，{CHAR_CN}抬头微顿，"
            f"指尖捏着{FIX_PROP_CN}，关东煮锅仍在画面右侧升腾热气，"
            f"暖白日光灯照明，玻璃柜反射，室内货架背景，"
            f"店内招牌均为纯色发光灯牌无文字，中景固定机位，"
            f"主体居中偏左，电影感构图"
        ),
    },
    "shot3": {
        "first": _frame(
            f"{STYLE_CN}。便利店室内，{CHAR_CN}正对镜头站立，正脸清晰可见，"
            f"他的手把一张绿色五元纸币轻轻放到面前的木质柜台上（柜台带收银机），"
            f"玻璃门在他身后作为背景（门外雨幕与街灯白光透过玻璃门可见），"
            f"暖白日光灯照明，店内招牌纯色发光灯牌无文字，中景，主体居中，电影感构图"
        ),
        "last": _frame(
            f"{STYLE_CN}。便利店室内，{CHAR_CN}正对镜头站立，正脸清晰可见，"
            f"他的手刚把一张绿色五元纸币放到面前的木质柜台上（柜台带收银机），"
            f"另一手握着未撑开的黑伞，玻璃门在他身后作为背景"
            f"（门外雨幕与街灯白光透过玻璃门可见），"
            f"暖白日光灯照明，店内招牌纯色发光灯牌无文字，中景，主体居中，电影感构图"
        ),
    },
