#!/usr/bin/env python3
"""P5-v5 拼接：shot1+shot2+shot3 concat + 音频 acrossfade 0.25s -> video_silent_v5.mp4。"""
...
CLIPS = ROOT / "output" / "clips_v5"
OUT = ROOT / "output" / "out"
META = ROOT / "output" / "tmp" / "p5v5_concat_meta.json"
