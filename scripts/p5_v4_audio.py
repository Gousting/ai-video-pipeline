...
"""P5-v4 音频环节（钢琴收束）：
  ...
  5. 视频流 copy 自 video_silent_v4.mp4 -> final_v4.mp4
"""
...
VIDEO_SILENT = OUT / "video_silent_v4.mp4"
PIANO = TMP / "piano_ending.wav"
NARRATION = TMP / "narration_v4.mp3"
AMBIENT = TMP / "ambient_v4.wav"
FINAL = OUT / "final_v4.mp4"
META = TMP / "p5v4_audio_meta.json"
...
def main() -> int:
    ...
    print(f"[audio] video_silent_v4 时长 {duration:.3f}s", flush=True)
    ...
    print(f"[audio] final_v4 -> {FINAL}", flush=True)
