...
"""P5-v4 后处理：
  ...
  3. 音频回混：final_v4.mp4 音轨 copy 回 1080p 成片 -> output/out/final_v4_1080p.mp4

CLI:
  python p5_v4_post.py rife --video <mp4> --out <mp4>
  python p5_v4_post.py finalize --rife <mp4> --audio <mp4> --out <mp4>
"""
...
def main(argv=None) -> int:
    ...
    p1.add_argument("--prefix", default="p5v4_rife")
